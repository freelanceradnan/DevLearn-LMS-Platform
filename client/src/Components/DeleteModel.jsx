...
const DeleteModel = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden transform transition-all"
      ...
      >
        ...
        <div className="p-6">
          <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
            Are you sure you want to delete this item? This will be delete
            permanently!
          </p>
        </div>
