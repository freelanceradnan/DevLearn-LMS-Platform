...
const slidesData = [
  {
    ...
    description:
      "Break through into your next role with job-ready skills in AI, data, and more from IBM.",
      ...
      >
        {slidesData.map((slide) => (
          <SwiperSlide key={slide.id}>
            ...
            <div
              className={`${slide.bgClass} text-white rounded-3xl p-6 md:p-8 h-[300px] relative overflow-hidden`}
            >
